...
#code if you dont have the packages 
install.packages("trend") #usa that to install all the packages that are necessary
...
setwd()
setwd("/Users/danielpinchuk/Desktop/Primeiro Semestre/TPMDF") #my work directory above you should find yours

#df
ko   <- read_csv("KO_daily.csv",   col_types = cols(Date = col_date())) #adjusted prices of coca-cola
tsla <- read_csv("TSLA_daily.csv", col_types = cols(Date = col_date())) #adjusted prices of tesla
